...
export function renderPayementSection(){
  ...
  let paymentHtml=`
      ...
      <div class="order-summary-payement">
        <div class="items-grid"><span class="price">Items Price:</span> &#8377 ${itemsPrice}</div>
        <div  class="items-grid"><span class="price">shipping & handling :</span> &#8377 ${shippingAndHandling}</div>
        <div  class="items-grid"><span class="price">Total Before Tax:</span><span class="total-before-tax"> &#8377 ${totalBeforeTax}</span></div>
        <div class="items-grid"><span class="price"> GST(18%) :</span> &#8377 ${GST}</div>
        <div class="items-grid price-border"><span class="price">Final Price:</span> &#8377 ${finalPrice}</div>
